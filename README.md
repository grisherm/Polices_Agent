...
Los 45 casos fueron reescritos para usar preguntas y datos verificables en los
documentos de Nexus Logistics & Tech (ver [reporte_pruebas.md](reporte_pruebas.md)),
pero la suite todavía no se ejecutó de punta a punta contra un LLM real en
este repositorio. Ejecuta `python test_agente_ligero.py` con el backend
corriendo para generar el reporte real; el script sobrescribe
`reporte_pruebas.md` automáticamente, caso por caso.
